...
public class QuestionService {
    ...
    public PaginationDTO listwithColumn(String search, String tag, String sort, Integer page, Integer size, Integer column2, UserAccount userAccount) {
        ...
        for (Question question : questions) {
            ...
            else if (userAccount != null && userAccount.getGroupId() >= questionDTO.getPermission())
                questionDTO.setIsVisible(1);
    ...
    public String getShortDescription(String description, Long id) {
        ...
        */
        ...
        if (imgSrc.size() == 1)
            shortDescription = shortDescription + "<br><img style=\"max-width:49%;max-height:300px\" src=\"" + imgSrc.get(0) + "\">";
    ...
    public int delQuestionById(Long user_id, Integer group_id, Long id) {
        ...
        // 发送mq
        amqpTemplate.convertAndSend(RabbitmqConfig.es_change, RabbitmqConfig.es_bind_key, new PostMqMessage(question.getId(), PostMqMessage.REMOVE));
